...
// Application settings from persistent state.
export default function SettingsPage() {
  ...
  return (
    <>
      <PhasePlaceholder
        eyebrow="User Module / Persistent Settings"
        title="تنظیمات برنامه"
        description="تنظیمات، حساب‌های ثبت‌شده و وضعیت ورود اکنون در فضای ذخیره‌سازی مرورگر نگهداری می‌شوند."
        items={[
          'ذخیره دائمی تنظیمات و اطلاعات کاربران',
          'پشتیبانی از نشست موقت و ورود دائمی',
          'بازیابی خودکار حساب فعال پس از Refresh',
          'امکان بازنشانی امن داده‌های آزمایشی',
        ]}
      >
        ...
        <div className="settings-grid">
          ...
          <section className="content-card settings-card">
            ...
            <p className="persistence-card-description">
              حساب‌ها، تنظیمات و
              وضعیت ورود آزمایشی در
          ...
          <section className="content-card settings-card danger-card">
            ...
            <p>
              حذف واقعی حساب در این
              فاز انجام نمی‌شود و
              بعداً به پنجره تأیید و
      ...
      >
        <p className="persistence-reset-note">
          با تأیید این عملیات،
          اطلاعات آزمایشی به حالت
          اولیه بازمی‌گردند.
        </p>

        <ul className="persistence-reset-list">
          <li>
            حساب‌های ثبت‌نام‌شده
            جدید حذف می‌شوند.
          </li>
