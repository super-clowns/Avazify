...
export function ProfilePage() {
  ...
  const handleFollow = () => {
    ...
    pushToast(isFollowing ? 'دنبال‌کردن کاربر لغو شد.' : 'کاربر را دنبال کردید.', 'success');
  };
...
function ArtistProfileContent({ artist }: { artist: User }) {
  ...
  const handleFollow = () => {
    ...
    pushToast(isFollowing ? 'دنبال‌کردن هنرمند لغو شد.' : 'هنرمند را دنبال کردید.', 'success');
  };
